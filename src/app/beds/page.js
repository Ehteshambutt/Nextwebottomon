...
// Dynamic imports to disable SSR for components that are client-side only
const Drawer = dynamic(() => import("../../components/ButtomDrawer"), { ssr: false });
const ProductFilter = dynamic(() => import("../../components/ProductFilter"), { ssr: false });
const ProductGridSelector = dynamic(() => import("../../components/ProductGridSelector"), { ssr: false });
